package com.example.nestedscrollingdemo.view;
...
public class NestedTraditionLayout extends LinearLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        /**
         * and运算的结果总是小于等于0x000000ff，
         * 那就是说and之后，无论你多少根手指加进来，
         * 都是会ACTION_POINTER_DOWN或者ACTION_POINTER_UP
         */
        int action = event.getAction() & MotionEvent.ACTION_MASK;
        Log.d(TAG, "onInterceptTouchEvent: 接收到事件");
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                int dy = mLastY - y;
                //如果父控件拦截，根据传统事件传递机制，如果父控件确定拦截事件，那么在同一事件序列中，
                // 子控件是没有办法获取到事件的。
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        /**
         * 就是这里的代码 简单就让 tablayout卡住了而且不下滑
         */
